...
preflight(){
    ...
    warn "Raggzinn https://github.com/Raggzinn"
    warn ""
    warn "Desenvolvido por Raggzinn"
    warn ""
    warn "https://github.com/Raggzinn/Pterodactyl"
    warn ""
...
os_check(){
    ...
    if [ "$lsb_dist" =  "ubuntu" ]; then
        if  [ "$dist_version" != "22.04" ] && [ "$dist_version" != "20.04" ] && [ "$dist_version" != "18.04" ]; then
